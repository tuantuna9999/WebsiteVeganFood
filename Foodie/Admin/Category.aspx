                                                    ...
                                                    <asp:Repeater ID="rCategory" runat="server" OnItemCommand="rCategory_ItemCommand" OnItemDataBound="rCategory_ItemDataBound">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkEdit" Text="Edit" style="background-color:yellow; font-size:20px; color:black" runat="server" CssClass="badge badge-primary" CommandArgument='<%#Eval("CategoryID") %>' CommandName="edit">
                                                                    <i class="ti-pencil"></i>
                                                                    </asp:LinkButton>
